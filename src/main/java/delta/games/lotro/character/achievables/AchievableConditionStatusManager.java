...
public class AchievableConditionStatusManager
{
  ...
  public void updateStatusFromItems()
  {
    ...
    {
      _status.setState(AchievableElementState.COMPLETED);
      _status.setCount(null);
    }
    else if (completedCount==0)
    {
      _status.setState(AchievableElementState.UNDEFINED);
      _status.setCount(null);
    }
    else
    {
      _status.setState(AchievableElementState.UNDERWAY);
      _status.setCount(Integer.valueOf(completedCount));
