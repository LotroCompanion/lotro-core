...
public class AchievableStatusBusinessRules
{
   ...
   */
  public static void setAchievableState(AchievableElementState newState, AchievableStatus status)
  {
   ...
   * @param status Status to update.
   */
  public static void setObjectiveState(AchievableElementState newState, AchievableObjectiveStatus status)
  {
    if (status.getState()==newState)
    {
      return;
   ...
   * @param status Status to update.
   */
  public static void setConditionState(AchievableElementState newState, ObjectiveConditionStatus status)
  {
    if (status.getState()==newState)
    {
      return;
   ...
   * @param status Status to update.
   */
  public static void setConditionCount(Integer newCount, ObjectiveConditionStatus status)
  {
