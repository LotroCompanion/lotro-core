 ...
 * skill attacks description in XML.
 * @author DAM
 */
public class SkillAttacksXMLConstants
{
  /**
   * Tag 'attack'.
   */
  ...
  /**
   * Tag 'attack', attribute 'damageQualifier'.
   */
   ...
   */
  public static final String ATTACK_MAX_DAMAGE_ATTR="maxDamage";
  /**
   * Tag 'attack', attribute 'maxDamageVariance'.
   */
  public static final String ATTACK_MAX_DAMAGE_VARIANCE_ATTR="maxDamageVariance";
  /**
   * Tag 'attack', attribute 'maxDamageProgression'.
   */
   ...
   */
  public static final String ATTACK_IMPLEMENT_CONTRIBUTION_MULTIPLIER_ATTR="implementContributionMultiplier";
  /**
   * Tag 'attack', attribute 'flags'.
   */
  public static final String ATTACK_FLAGS_ATTR="flags";
}
