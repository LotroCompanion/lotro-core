 ...
 * @author DAM
 */
public class CarryAllsDefinitionsManager
{
  private static final Logger LOGGER=Logger.getLogger(CarryAllsDefinitionsManager.class);

  private static CarryAllsDefinitionsManager _instance=null;
   ...
   */
  public static CarryAllsDefinitionsManager getInstance()
  {
    if (_instance==null)
    {
      _instance=load();
   ...
   * Constructor.
   */
  public CarryAllsDefinitionsManager()
  {
   ...
   */
  private static CarryAllsDefinitionsManager load()
  {
    LotroCoreConfig cfg=LotroCoreConfig.getInstance();
    File carryAllsFile=cfg.getFile(DataFiles.CARRY_ALLS);
    long now=System.currentTimeMillis();
    CarryAllsDefinitionsManager mgr=new CarryAllDefinitionXMLParser().parseXML(carryAllsFile);
